use crate::client::cookie::{from_tower_cookie_deref, Cookie};
...
pub struct Client {
    ...
    reqwest_client: tauri_plugin_http::reqwest::Client,
}
...
impl Client {
    ...
    pub fn reqwest_client(&self) -> &tauri_plugin_http::reqwest::Client {
        &self.reqwest_client
    }
}

pub fn new_client(base_url: impl Into<BaseUrl>) -> Result<Client> {
    let reqwest_builder = tauri_plugin_http::reqwest::Client::builder();
...
pub fn new_client_with_reqwest(
    ...
    reqwest_builder: tauri_plugin_http::reqwest::ClientBuilder,
) -> Result<Client> {
